...
def sagemakerProjectName = "aivs-git-jenkins-hsrs-7"
def sagemakerProjectId = "p-77j6jcpds5re"
def sagemakerProjectArn= "arn:aws:sagemaker:ap-southeast-1:141219929686:project/aivs-git-jenkins-hsrs-7"
def sourceModelPackageGroupName = "aivs-git-jenkins-hsrs-7-p-77j6jcpds5re"
def modelExecutionRole = "arn:aws:iam::141219929686:role/service-role/AmazonSageMakerServiceCatalogProductsUseRole"
def awsRegion = "ap-southeast-1"
def artifactBucket = "sagemaker-project-p-77j6jcpds5re"
